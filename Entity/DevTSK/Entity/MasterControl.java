	...
	public static void main(String[] args) throws IOException, ConfigException {
		...
		if (args.length < 1 || args[0].equalsIgnoreCase("actual") || args[0].equalsIgnoreCase("Default")) {
			...
			h = new EntityLoader(new Entity[] {
					...
					new UnMarriedPonii("Tree Lighting Radon", "Tree", "", true, true, "\nEarth\nCutest little filly ever sparkling with the same spark that her dad has\nShe lives with Blaze at SAA.", "\nApples with lightning bolt behind", "Little more yellow then AJ's", "Slightly darker orange then AJ", "Apple Jack", "Shadow Radon", new Day(11, 9, 2011), "lightning.png", "lightningmark.png")
							.addDNA(new DNA("003H000000FDA00000000003B0188FF00UN1837002000000I1FAFE730000001B107F3FCC004CB2")),
					new UnMarriedPonii("Shadow Jack Radon", "Jack", "", false, false, "\nUnicorn\nSecond Ponii on the AJ-Radon Line.\nSpends most of his time with Rhyne.", "\nA cloud with lightning", "Pale White and yellow", "Pale White and yellow", "Apple Jack", "Shadow Radon", new Day(25, 12, 2015), "jack.png", "jackmark.png")
							.addDNA(new DNA("002S000100FDA000FDA000000000FBE00UN1839000220001412F2F2FF9FD721B112F2F2FF9FD72")),
					new UnMarriedPonii("Rhyne Radon", "Rhyne", "", true, false, "\nUnicorn\nThird Ponii on the AJ-Radon Line.\nSpends most of her time with Jack.", "\nA cloud with Snowflakes", "WIP", "WIP", "Apple Jack", "Shadow Radon", new Day(27, 10, 2016), "rhyne.png", "rhynemark.png")
							.addDNA(new DNA("002S000100EAA000CA800010000DE00ADUN1839000000000I11F1F1FE0E0601B111F1F1FE0E060")),
